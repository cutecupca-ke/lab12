...
def display_chat_messages():
    ...
    for message in st.session_state.messages:
        with st.chat_message(message["role"]):
            ...
            st.markdown(f"**[{time_str}]** {message['content']}")
...
def main():
    ...
    if prompt := st.chat_input("Type your message here..."):
        ...
        #set date time
        format_datetime = now.strftime("%H:%M:%S")
...
'''
- Update the message structure to include timestamps
- Display timestamps in the chat interface
